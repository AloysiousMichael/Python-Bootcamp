...
#Timer
mylabel=Label(text="Timer",fg=GREEN,font=(FONT_NAME,35),bg=YELLOW)
mylabel.grid(column=1,row=0)

#Start


start_button=Button(text="Start",command=start_timer,width=5,highlightthickness=0)
start_button.grid(column=0,row=2)
#retest

start_button=Button(text="Reset",command=reset_timer,width=5,highlightthickness=0)
start_button.grid(column=2,row=2)

#tick

my_label2=Label(text="",fg=GREEN,bg=YELLOW)
